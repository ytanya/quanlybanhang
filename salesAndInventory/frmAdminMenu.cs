...
namespace skelot
{
    public partial class FrmAdminMenu : Form
    {
     ...
     //   string connection = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\Data.accdb";
        ...
        {
            this.Dispose();
            frmAddManufac frmAM = new frmAddManufac();
            frmAM.Show();
        }
        ...
        private void cậpNhậtMặtHàngToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Dispose();
            FrmUpdate frm8 = new FrmUpdate();
            frm8.Show();
        ...
        private void timKiếmSảnPhẩmToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Dispose();
            frmProductSearchName ProductSearch = new frmProductSearchName();
            ProductSearch.Show();
        }
        ...
        {
            this.Dispose();
            frmInsertProductStore frmIP = new frmInsertProductStore();
            frmIP.Show();
        }
        ...
        private void đơnVịChuyểnĐỗiToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Dispose();
            frmConversion frmCon = new frmConversion();
            frmCon.Show();
        }

        private void cậpNhậtĐơnVịChuyểnĐỗiToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Dispose();
            frmUpdateUnitMeasure frmUUM = new frmUpdateUnitMeasure();
            frmUUM.Show();
        }

        private void bánHangfToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Dispose();
